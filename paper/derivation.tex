...
\begin{frontmatter}
%\title{An Introduction to the Systematic Method to Implement Nearly Incompressible Hyperelastic Models with Mixed Formulation}
...
\clearpage
{\color{red} update book references with caps and edition numbers as 1st or 2nd edition.}
