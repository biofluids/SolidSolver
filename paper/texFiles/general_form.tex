\section{The General Process} \label{general}
...
\end{equation}
If we leave $p$ as an unknown and implement Equation \ref{pressure} as additional constraint, we will have a mixed formulation. If we replace $p$ with $\bold{u}$ using Equation \ref{pressure}, we end up with a displacement-base formulation.
