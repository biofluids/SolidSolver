...
Similarly, by setting $\mu_2$ to $0$ in Mooney-Rivlin model, we could easily get the isochoric part of the isotropic elasticity tensor. From Equation \ref{Ciso1}
