...
In mixed formulation we replace Equation \ref{vol} with
\begin{equation}
\Psi_{vol} = p(J - 1)
\end{equation}
...
%
We use the same volumetric part to account for compressibility as Mooney-Rivlin model. The volumetric part of both stress and elasticity tensor are the same as Mooney-Rivlin respectively. Therefore, we will only show the derivation of the isochoric components.

%
\subsubsection{The Decoupled Form of Yoeh Model}
...
\begin{equation}
\begin{split}
\frac{2}{3}Tr(J^{-2/3}\overline{\bold{S}})\tilde{\mathbb{P}} &= \frac{2}{3}J^{-2/3}\overline{\bold{S}} : \bold{C}
\end{split}
\end{equation}
